...
class TestKHQR(unittest.TestCase):
    def setUp(self):
        self.__bakong_token = os.getenv("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJkYXRhIjp7ImlkIjoiN2ZhNDI0ZjM5YWNkNDY3MSJ9LCJpYXQiOjE3ODAwMTAxMTEsImV4cCI6MTc4Nzc4NjExMX0.r751NmCFRWj2ZIrM_xgawDV_Bww49laN3-ViMf9xQv8")
    ...
    def test_create_qr(self):
        ...
        deeplink = self.khqr.generate_deeplink(
            qr, 
            appDeepLinkCallback="https://checkout-sandbox.payway.com.kh/api/payment-gateway/v1/payments", 
